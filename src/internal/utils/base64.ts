...
export const toBase64 = (data: string | Uint8Array | null | undefined): string => {
  ...
  throw new FlowgladError('Cannot generate base64 string; Expected `Buffer` or `btoa` to be defined');
};
...
export const fromBase64 = (str: string): Uint8Array => {
  ...
  throw new FlowgladError('Cannot decode base64 string; Expected `Buffer` or `atob` to be defined');
};
