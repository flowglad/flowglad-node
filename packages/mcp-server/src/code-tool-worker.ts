...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Flowglad)`
    : `const run: (${functionSource.client}: Flowglad) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.invoiceLineItems.list',
    'client.invoiceLineItems.retrieve',
    'client.pricingModels.clone',
    'client.pricingModels.create',
    'client.pricingModels.list',
    'client.pricingModels.retrieve',
    'client.pricingModels.retrieveDefault',
    'client.pricingModels.update',
    ...
    'client.customers.retrieveBilling',
    ...
    'client.usageEvents.create',
    'client.usageEvents.retrieve',
    'client.usageMeters.create',
    'client.usageMeters.list',
    'client.usageMeters.retrieve',
    'client.usageMeters.update',
  ],
